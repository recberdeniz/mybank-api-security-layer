...
public class CustomerServiceTest extends TestSupport {
	...
	public void setUp() throws Exception {
		...
		service = new CustomerService(customerRepository, converter, encoder);
	}
	...
	public void whenUpdateCustomerCalledWithValidUpdateCustomerRequest_itShouldReturnValidCustomerDto(){
		...
		Customer customer = new Customer(id, "name", "name", "1234",
				2000, City.ANKARA, "address", null, Set.of(Role.ROLE_USER),
				true, true, true, true);
